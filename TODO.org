...
current: Client / Runtime Hypermedia

** Live On

- [ ] Init File for Daemon
- [ ] Parellel Development / Release Instances
- [ ] Daemon Installation Hook
- [ ] Supervisors for restarting terminated processes
...
- [ ] Rust Macros to compress Lyric implementation
- [ ] Pretty Printing Code / S-Expressions
