...
pub/sub is not retained and slow or disconnected subscribers can miss events.
...
** DONE Replace native service syntax builders
=srv!= and =spawn_srv!= are defined in Lyric; the native adapters are removed.
