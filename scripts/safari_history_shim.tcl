...
set output "(\n"
    ...
    historydb eval {
        SELECT datetime(visit_time + 978307200, 'unixepoch', 'localtime') as local_visit_time, TRIM(title) as trim_title, MIN(url) as min_url, domain_expansion, *
        FROM history_visits
        ...
        append output "(:safari_history_item :title \"$trim_title\" :url \"$min_url\" :domain_expansion \"$domain_expansion\")"
    }
}
