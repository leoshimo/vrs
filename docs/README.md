...
the shared page layout, navigation, source downloads, and code highlighting.
...
changes on `main` also deploy it to GitHub Pages. Generated HTML does not have to
be committed for publishing.
